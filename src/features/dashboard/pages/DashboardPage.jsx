...
export default function DashboardPage() {
  ...
  // Daily 예시 데이터 (실제로는 API에서 가져올 데이터)
  ...
  // Month 예시 데이터 - 캘린더 (각 날짜의 감정 값)
  // 실제로는 API에서 받아올 데이터
  // 날짜를 키로 사용하는 객체로 변환
  const monthCalendarDataMap = {
  ...
  // 감정 캐릭터 SVG 렌더링 함수
  const renderEmotionCharacter = (character) => {
    switch (character) {
      case "depression":
        return (
          <svg width="33" height="30" viewBox="0 0 21 19" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      case "anger":
        return (
          <svg width="33" height="30" viewBox="0 0 23 21" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      case "sadness":
        return (
          <svg width="33" height="30" viewBox="0 0 19 25" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      case "anxiety":
        return (
          <svg width="33" height="30" viewBox="0 0 25 17" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      case "neutral":
        return (
          <svg width="33" height="30" viewBox="0 0 24 18" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      case "happiness":
        return (
          <svg width="33" height="30" viewBox="0 0 25 22" fill="none" xmlns="http://www.w3.org/2000/svg">
